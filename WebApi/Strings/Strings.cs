namespace WebApi.Strings
{
    ...
    {
        public const string CompanyNotFound = "It was not possible to find the company with id {0}.";
        public const string ProductNotFound = "It was not possible to find the product with id {0}.";
